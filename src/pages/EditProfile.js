      ...
      <Modal
        ...
        <View
          ...
          <View
            style={{
              margin: 20,
              backgroundColor: COLORS_PAGES.primary,
              alignItems: "center",
              justifyContent: "center",
              borderRadius: 20,
              padding: 35,
            ...
            <DatePicker
              ...
              options={{
                ...
                textDefaultColor: COLORS_PAGES.white,
                selectedTextColor: COLORS_PAGES.white,
                mainColor: "#469ab6",
                textSecondaryColor: COLORS_PAGES.white,
                borderColor: "rgba(122,146,165,0.1)",
              }}
            />

            <TouchableOpacity onPress={handleOnPressStartDate}>
              <Text style={{ ...FONTS.body3, color: COLORS_PAGES.white }}>
                Close
              </Text>
            </TouchableOpacity>
          </View>
